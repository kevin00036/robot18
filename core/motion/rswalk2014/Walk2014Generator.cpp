...
#define UNSW_EPSILON 0.01       //10 mm
...
JointValues Walk2014Generator::makeJoints(ActionCommand::All* request,
  ...
  balanceAdjustment = filteredGyroY / 25.0f;               // adjust ankle tilt in proportion to filtered gryoY
  ...
  if (limp.elapsed_ms() < 500 && armStuck &&  (not in_walk_kick_ or bodyModel.walkKickStart == false)) {
